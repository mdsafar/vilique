-- Roll back 202607240001_stale_editor_lock_expiry_and_release.sql.
-- That migration only replaced these three function bodies. Recreate their
-- immediately preceding definitions without changing ownership or grants.
